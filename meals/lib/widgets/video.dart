...
class VideoInstructions extends StatefulWidget {
  const VideoInstructions({super.key, required this.videoId});
  final String videoId ;

  @override
  State<VideoInstructions> createState() => _VideoInstructionsState();
}

class _VideoInstructionsState extends State<VideoInstructions> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Instructions Video"),
      ),
      body: Stack(
        children: [
